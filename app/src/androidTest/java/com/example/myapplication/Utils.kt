...
enum class SmartObjCoords(val startP: Pair<Int,Int>, val endP: Pair<Int,Int>) {
    ...
    EZVIZ_SMARTBULB_SATURATION_BTN(Pair(181,256),Pair(297,371)),
    ...
    EZVIZ_SMARTBULB_EDIT_SATURATION_BRIGTH_CIRCLE(Pair(96,441),Pair(984,1223)),
...
enum class SmartObjResourceIDs(val rid: String) {
    ...
    TAPO_SMARTBULB_EDIT_PRESET_WHITE_LIGHT_COLOR_SATURATION("com.tplink.iot:id/color_temperature_view"),
